<?php
// Resume session to check login status
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 md:relative md:h-screen z-10 w-full md:w-64 md:flex md:flex-col">
            <div class="md:mt-12 text-left">
        ...
        <div class="flex-1 pb-24 md:pb-5">
            <div class="w-full bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <?php else: ?>
                    <span></span> <!-- Placeholder for other header items -->
                <?php endif; ?>
            </div>
            <div class="p-6">
